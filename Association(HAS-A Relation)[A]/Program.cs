...
namespace Association_HAS_A_Relation__A_
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ourBank.AddAccount(new Account("Akash", 5000, new Address(4, 10, "Sylhet")));
            ourBank.AddAccount(new Account("Rahim", 3000, new Address(7, 20, "Chittagong")));
            //ourBank.PrintAllAccounts();
            //ourBank.SearchAccount(1002);
            //ourBank.DeleteAccount(1002);
            //ourBank.PrintAllAccounts();
            ourBank.Transaction();
        }
    }
